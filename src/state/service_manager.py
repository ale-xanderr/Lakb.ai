...
class ServiceManager:
    ...
    Ensures services (API, Auth, Favorites, Profile, Geolocation, Interaction) are created once and reused across the application.
    """
    ...
    def __init__(self):
        if not self._initialized:
            ...
            self._interaction_service: Optional[InteractionService] = None
    ...
    def interaction_service(self) -> InteractionService:
        """Get or create InteractionService instance."""
